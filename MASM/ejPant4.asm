...
atributo db 07 ; se coloca como primer atributo el atributo normal
datasg ends
...
lea dx,mens1 ; se escribe mensaje que solicita carácter
call escribe_cad

call lee16_0 ; lee carácter
call esc_10_2; lo muestra

pop dx ; se recupera la dirección del cursor
mov cx,23 ; se establece número de veces a realizar el proceso
...
mov cx,10 ; se escribirá 10 veces el carácter contenido en AL
mov bl,atributo ; se coloca el atributo en bl
call esc_10_1
pop cx ; se reestablece el contador
inc atributo ; se modifica el atributo
loop cicloe	
